...
import 'html-escaper';
import { $ as $$Theme, t as transparentLayout, a as $$Layout } from './404.astro.18f7f3b8.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<main class="w-full xl:w-container mx-auto mt-24 px-4 xl:px-0">
    ...
    <section class="w-full mb-20 flex flex-col">
    ...
    <hr class="w-1/2 mx-auto">
    <section class="w-full mb-20 flex flex-col">
      <h3 class="mb-10 text-2xl text-start">Projects</h3>
      <div class="w-full grid grid-cols-2 sm:grid-cols-5 gap-8">
      </div>
    </section>
