...
import 'html-escaper';
import { $ as $$Theme, t as transparentLayout, a as $$Layout } from './404.astro.71a6a83e.mjs';
...
const $$HamburgerMenuMobile = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section id="list-menu-mobile" class="top-14 absolute hidden w-full origin-top animate-open-menu flex-col justify-center bg-theme-light dark:bg-theme-dark text-5xl text-pantone">
  <nav class="flex min-h-screen flex-col items-center py-10" aria-label="mobile">
...
const nextJs = {"src":"/_astro/next-js.697a4252.svg","width":128,"height":128,"format":"svg"};
...
const gitHub = {"src":"/_astro/git-hub.46d9652d.svg","width":128,"height":128,"format":"svg"};
...
const $$Experience = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const nextJsAlt = "Next.js";
  const astroAlt = "Astro";
  const visualStudioCodeAlt = "Visual Studio Code";
  const gitHubAlt = "GitHub";
  const gitLabAlt = "GitLab";
  return renderTemplate`${maybeRenderHead()}<figure class="w-full flex flex-col xl:flex-row-reverse justify-center items-center gap-x-5 sm:gap-y-2.5 hover:scale-75 delay-150 transition-all">
  <figcaption>HTML5</figcaption>
  <img${addAttribute(html.src, "src")}${addAttribute(72, "width")}${addAttribute(72, "height")} loading="lazy" decoding="async"${addAttribute(htmlAlt, "alt")} class="p-2">
</figure>
<figure class="w-full flex flex-col xl:flex-row-reverse justify-center items-center gap-x-5 sm:gap-y-2.5 hover:scale-75 delay-150 transition-all">
  <figcaption>CSS3</figcaption>
  <img${addAttribute(css.src, "src")}${addAttribute(72, "width")}${addAttribute(72, "height")} loading="lazy" decoding="async"${addAttribute(cssAlt, "alt")} class="p-2">
</figure>
<figure class="w-full flex flex-col xl:flex-row-reverse justify-center items-center gap-x-5 sm:gap-y-2.5 hover:scale-75 delay-150 transition-all">
  <figcaption>JavaScript</figcaption>
  <img${addAttribute(javaScript.src, "src")}${addAttribute(72, "width")}${addAttribute(72, "height")} loading="lazy" decoding="async"${addAttribute(javaScriptAlt, "alt")} class="p-2">
</figure>
<figure class="w-full flex flex-col xl:flex-row-reverse justify-center items-center gap-x-5 sm:gap-y-2.5 hover:scale-75 delay-150 transition-all">
  <figcaption>Tailwind&nbsp;CSS</figcaption>
  <img${addAttribute(tailwindCss.src, "src")}${addAttribute(72, "width")}${addAttribute(72, "height")} loading="lazy" decoding="async"${addAttribute(tailwindCssAlt, "alt")} class="p-2">
</figure>
<figure class="w-full flex flex-col xl:flex-row-reverse justify-center items-center gap-x-5 sm:gap-y-2.5 hover:scale-75 delay-150 transition-all">
  <figcaption>React</figcaption>
  <img${addAttribute(reactJs.src, "src")}${addAttribute(72, "width")}${addAttribute(72, "height")} loading="lazy" decoding="async"${addAttribute(reactJsAlt, "alt")} class="p-2">
</figure>
<figure class="w-full flex flex-col xl:flex-row-reverse justify-center items-center gap-x-5 sm:gap-y-2.5 hover:scale-75 delay-150 transition-all">
  <figcaption>Next.js</figcaption>
  <img${addAttribute(nextJs.src, "src")}${addAttribute(72, "width")}${addAttribute(72, "height")} loading="lazy" decoding="async"${addAttribute(nextJsAlt, "alt")} class="p-2">
</figure>
<figure class="w-full flex flex-col xl:flex-row-reverse justify-center items-center gap-x-5 sm:gap-y-2.5 hover:scale-75 delay-150 transition-all">
  <figcaption>Astro</figcaption>
  <img${addAttribute(astro.src, "src")}${addAttribute(72, "width")}${addAttribute(72, "height")} loading="lazy" decoding="async"${addAttribute(astroAlt, "alt")} class="p-2">
</figure>
<figure class="w-full flex flex-col xl:flex-row-reverse justify-center items-center gap-x-5 sm:gap-y-2.5 hover:scale-75 delay-150 transition-all">
  <figcaption>VS&nbsp;Code</figcaption>
  <img${addAttribute(visualStudioCode.src, "src")}${addAttribute(72, "width")}${addAttribute(72, "height")} loading="lazy" decoding="async"${addAttribute(visualStudioCodeAlt, "alt")} class="p-2">
</figure>
<figure class="w-full flex flex-col xl:flex-row-reverse justify-center items-center gap-x-5 sm:gap-y-2.5 hover:scale-75 delay-150 transition-all">
  <figcaption>GitHub</figcaption>
  <img${addAttribute(gitHub.src, "src")}${addAttribute(72, "width")}${addAttribute(72, "height")} loading="lazy" decoding="async"${addAttribute(gitHubAlt, "alt")} class="p-2">
</figure>
<figure class="w-full flex flex-col xl:flex-row-reverse justify-center items-center gap-x-5 sm:gap-y-2.5 hover:scale-75 delay-150 transition-all">
  <figcaption>GitLab</figcaption>
  <img${addAttribute(gitLab.src, "src")}${addAttribute(72, "width")}${addAttribute(72, "height")} loading="lazy" decoding="async"${addAttribute(gitLabAlt, "alt")} class="p-2">
</figure>`;
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<main class="w-full xl:w-container mx-auto mt-24 px-4 xl:px-0">
    ...
    <hr class="w-1/2 mx-auto">
    <section id="experience" class="w-full mb-20 flex flex-col">
      <h3 class="my-10 text-2xl text-start">Experience</h3>
      <div class="w-full grid grid-cols-2 sm:grid-cols-5 gap-8">
        ${renderComponent($$result2, "Experience", $$Experience, {})}
      </div>
    </section>
    <hr class="w-1/2 mx-auto">
    <section id="projects" class="w-full mb-20 flex flex-col">
      <h3 class="my-10 text-2xl text-start">Projects</h3>
      <div class="w-full grid grid-cols-2 sm:grid-cols-5 gap-8">
      </div>
    </section>
