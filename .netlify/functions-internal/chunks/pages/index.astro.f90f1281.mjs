...
import 'html-escaper';
import { $ as $$Theme, t as transparentLayout, a as $$Layout } from './404.astro.d9c67c62.mjs';
...
const mySelfTransparent = {"src":"/_astro/my-self-transparent.19f6a08e.png","width":1276,"height":1280,"format":"png"};
    ...
    <section id="hero" class="w-full mb-24 flex flex-col items-center scroll-mt-24">
      ...
      <div class="w-full flex justify-center">
        <figure class="relative flex justify-center items-center bg-gradient-to-b from-pantone from-20% to-black-dark to-90% rounded-full shadow-md overflow-hidden">
          ...
          ${renderComponent($$result2, "Image", $$Image, { "src": mySelfTransparent, "width": 300, "alt": mySelfTransparentAlt, "quality": "max", "class": "absolute object-cover top-4 left-2" })}
        </figure>
      </div>
    </section>
