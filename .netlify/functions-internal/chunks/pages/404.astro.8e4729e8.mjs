...
const $$404 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<main class="w-full xl:w-container mx-auto px-4 xl:px-0">
    <h2 class="mt-14 mb-6 text-3xl font-medium text-black-dark dark:text-grey-light">Oops!</h2>
    <p class="mb-8 text-2xl font-light">
