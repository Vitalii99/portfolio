...
import 'html-escaper';
import { $ as $$Theme, t as transparentLayout, a as $$Layout } from './404.astro.ee693c7c.mjs';
...
const mySelfTransparent = {"src":"/_astro/my-self-transparent.14d6e7c2.png","width":2035,"height":1878,"format":"png"};
    ...
    <section id="hero" class="w-full mb-24 flex flex-col items-center scroll-mt-24">
      ...
      <div class="w-full flex justify-center">
        <figure class="relative flex justify-center items-center bg-gradient-to-b from-pantone from-20% to-black-dark to-90% rounded-full shadow-md overflow-hidden">
          ...
          ${renderComponent($$result2, "Image", $$Image, { "src": mySelfTransparent, "width": 280, "alt": mySelfTransparentAlt, "quality": "max", "class": "absolute object-cover" })}
        </figure>
      </div>
    </section>
