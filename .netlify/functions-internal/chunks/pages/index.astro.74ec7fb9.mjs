...
const mySelfTransparent = {"src":"/_astro/my-self-transparent.f4927a8a.png","width":4429,"height":4429,"format":"png"};
    ...
    <section id="hero" class="w-full mb-24 flex flex-col items-center scroll-mt-24">
      ...
      <div class="w-full flex justify-center">
        <figure class="relative flex justify-center items-center bg-gradient-to-b from-pantone from-20% to-black-dark to-90% rounded-full shadow-md overflow-hidden">
          ...
          ${renderComponent($$result2, "Image", $$Image, { "src": mySelfTransparent, "width": mySelfTransparent.width, "height": mySelfTransparent.height, "alt": mySelfTransparentAlt, "quality": "max", "class": "absolute object-contain" })}
        </figure>
      </div>
    </section>
