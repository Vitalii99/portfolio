...
import 'html-escaper';
import { $ as $$Theme, t as transparentLayout, a as $$Layout } from './404.astro.9ae2f322.mjs';
...
const nextJs = {"src":"/_astro/next-js.861fd1c0.svg","width":128,"height":128,"format":"svg"};

const astro = {"src":"/_astro/astro.f48e0276.svg","width":128,"height":128,"format":"svg"};

const visualStudioCode = {"src":"/_astro/visual-studio-code.503d580c.svg","width":128,"height":128,"format":"svg"};

const gitHub = {"src":"/_astro/git-hub.45262793.svg","width":128,"height":128,"format":"svg"};
...
const $$Experience = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<figure class="w-full flex flex-col xl:flex-row-reverse justify-center items-center gap-x-5 sm:gap-y-2.5 hover:scale-75 duration-300">
...
<figure class="w-full flex flex-col xl:flex-row-reverse justify-center items-center gap-x-5 sm:gap-y-2.5 hover:scale-75 duration-300">
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<main class="w-full xl:w-container mx-auto mt-24 px-4 xl:px-0">
    ...
    <section class="w-full my-10 flex flex-col">
      <h3 class="mb-10 text-2xl text-start">Experience</h3>
