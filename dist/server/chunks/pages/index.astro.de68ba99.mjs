...
import 'html-escaper';
import { $ as $$Theme, t as transparentLayout, a as $$Layout } from './404.astro.59c690cf.mjs';
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="flex items-center py-2.5 astro-K2F5ZB5C">
    <div class="flex gap-x-7 astro-K2F5ZB5C">
      <div class="flex gap-x-7 items-center astro-K2F5ZB5C">
